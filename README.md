...
See [release notes for StoX 4.2.1](https://github.com/StoXProject/StoX/blob/master/NEWS.md#stox-v421-2026-06-25).

Download StoX from (https://github.com/StoXProject/StoX/releases/tag/v4.2.1). For Windows download the .msi file, for MacOS download the .dmg file and for Linux download the .rpm or .deb file. Then follow the instructions below:
...
Step 2: 
Step 2: Install R 4.5 or newer if not already installed. It is recommended to use the latest version of R.

Step 3: 
Click on "Tools" > "R connection" in the menu to define the path to R (for example C:\Program Files\R\R-4.6.0\bin\x64).
