...
See [release notes for StoX 3.2.0](https://github.com/StoXProject/StoX/blob/master/NEWS.md#Stox-v320-2021-12-22).

Download StoX from (https://github.com/StoXProject/StoX/releases/tag/v3.2.0). For Windows download the .msi file, for MacOS download the .dmg file and for Linux download the .rpm or .deb file. Then follow the instructions below:
